  ...
  return (
    <>
      ...
      <Routes>
           ...
           {isSignedIn && <Route
            ...
            children={[
              ...
              <Route
                ...
                element={<Layout/>}
                children={[
                  <Route exact path="AddProvider" element = {<AddProvider />} key={'addProvider'}></Route>,
                  <Route exact path="AddFacility" element = {<AddFacilityAncillary />} key={'addFacility'}></Route>,
                  <Route exact path="AddAncillary" element = {<AddFacilityAncillary />} key={'addAncil'}></Route>,
           ...
           {isSignedIn && <Route exact path="/Home/UserDocuments" element={<UserDocuments/>} />}
           {isSignedIn && <Route exact path="/Home/SelfService" element = {<Tiles />}></Route>}
           ...
           {isSignedIn && <Route
            ...
            children={[
              ...
              <Route
               path='AddProvider'
               element = {<Layout/>}
               children={[<Route path="" element = {<AddProvider />} key={'dash'}></Route>,]}
              ></Route>,
              <Route
               path='AddFacility'
               element = {<Layout/>}
               children={[<Route path="" element = {<AddFacilityAncillary />} key={'dash'}></Route>,]}
              ></Route>,
              <Route
               path='AddAncillary'
               element = {<Layout/>}
              ...
              <Route
               ...
               element = {<Layout/>}
               children={[<Route path="" element = {<ProviderDemo />} key={'dash'}></Route>,]}
              ></Route>,
              <Route
              ...
              <Route
               ...
               element = {<Layout/>}
               children={[<Route path="" element = {<ProviderContracting />}> key={'dash'}</Route>,]}
              ></Route>,
              <Route
               path='FacAncHealthSystem'
               element = {<Layout/>}
               children={[<Route path="" element = {<FacAncHealthSystem />} key={'dash'}></Route>]}
              ></Route>,
              <Route
               path='Termination'
               element = {<Layout/>}
               children={[<Route path="" element = {<GroupTermination />} key={'dash'}></Route>]}
              ></Route>
            ]}
          >
           </Route>}

           <Route path='/DashboardLogin/*' element={<Navigate to={"/Dashboard"}/>}/>
           {/* <Route exact path="/DashboardLogin/AddProvider" element =
           {(prop.state !== null && prop.state.formNames === 'Add a Provider')?<NewWindow><AddProvider /></NewWindow>:<AddProvider />}></Route> */}

           <Route exact path="/ContractingHome" element={<ContractingHome/>} />
           <Route exact path="/ContractingHome/ProviderContracting" element = {<ProviderContracting/>}></Route>
           <Route exact path="/ContractingHome/FacAncHealthSystem" element = {<FacAncHealthSystem />}></Route>
