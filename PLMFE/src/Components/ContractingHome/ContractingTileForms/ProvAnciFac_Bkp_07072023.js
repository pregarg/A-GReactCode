...
export default function ProvAnciFac() {
  ...
  const handleMedicalGrpNoShow = (evt) => {
    ...
    state2Value =
      apiTestStateComp.state2.value !== undefined &&
      apiTestStateComp.state2.value !== ""
        ? apiTestStateComp.state2.value
        : "--";
    riskValue =
      apiTestStateComp.riskAttribute.value !== undefined &&
      apiTestStateComp.riskAttribute.value !== ""
        ? apiTestStateComp.riskAttribute.value.substring(0, 2)
        : "--";
    taxValue =
    ...
    console.log(
      "Inside handleMedicalGrpNoShow medicalGrpNoValue: ",
      medicalGrpNoValue,
    );
  ...
  const onSuccess = (response, typeOfRequest = "") => {
    ...
    if (response.status === 200) {
      ...
      selectJson.stateArray = response.data.map((ele) => {
  ...
  useEffect(() => {
    ...
    if (mastersSelector.hasOwnProperty("masterContractType")) {
      selectJson.contracts =
        mastersSelector["masterContractType"].length === 0
          ? []
          : mastersSelector["masterContractType"][0].data;
    }
    selectJson["contracts"]
      .filter((data) => data.transactionType == transType)
      .map((val) =>
    ...
    if (mastersSelector.hasOwnProperty("masterStateSymbol")) {
      const stateArray =
        mastersSelector["masterStateSymbol"].length === 0
          ? []
          : mastersSelector["masterStateSymbol"][0].data.map((ele) => {
              return { label: ele, value: ele };
            });
      ...
      customAxios
        ...
        .then((res) => {
          ...
          if (res.data.Status == 0) {
            ...
            //till here
            apiResponse.stateDefault = apiResponse.provState
              .split(",")
              .map((ele) => {
                return { label: ele, value: ele };
              });
    ...
    if (true) {
      let getApiJson = {};
      getApiJson["tableNames"] = getTableDetails()["compensationLinear"].concat(
        getTableDetails()["compGridTables"],
      );
      getApiJson["whereClause"] = { caseNumber: prop.state.caseNumber };
            ...
            respKeys.forEach((k) => {
              ...
              if (k === "compLinearTable") {
                ...
                if (respData[k][0] !== undefined) {
                  ...
                  apiResponse.state1 = {
                    label: apiResponse.state1,
                    value: apiResponse.state1,
                  };
                  apiResponse.contract = {
                    label: apiResponse.contract,
                    value: apiResponse.contract,
                  };
                  apiResponse.medicalLicense = {
                    label: apiResponse.medicalLicense,
                    value: apiResponse.medicalLicense,
                  };
                  apiResponse.state2 = {
                    label: apiResponse.state2,
                    value: apiResponse.state2,
                  };
                  apiResponse.riskAttribute = {
                    label: apiResponse.riskAttribute,
                    value: apiResponse.riskAttribute,
                  };
                  apiResponse.capitationType = {
                    label: apiResponse.capitationType,
                    value: apiResponse.capitationType,
                  };
                  apiResponse.capitationTerm = {
                    label: apiResponse.capitationTerm,
                    value: apiResponse.capitationTerm,
                  };
  ...
  const handleLinearSelectChange = (selectValue, evnt) => {
    ...
    if (name === "state1" || name === "medicalLicense" || name === "contract") {
      ...
      state1Value =
        name === "state1"
          ? selectValue.value
          : apiTestStateComp.state1.value !== undefined &&
              apiTestStateComp.state1.value !== ""
            ? apiTestStateComp.state1.value
            : "--";
      contractValue =
        name === "contract"
          ? selectValue.value
          : apiTestStateComp.contract.value !== undefined &&
              apiTestStateComp.contract.value !== ""
            ? apiTestStateComp.contract.value
            : "--";
      medicalLicenseValue =
        name === "medicalLicense"
          ? selectValue.value
          : apiTestStateComp.medicalLicense.value !== undefined &&
              apiTestStateComp.medicalLicense.value !== ""
            ? apiTestStateComp.medicalLicense.value
            : "---";
      ...
      console.log(
        "Inside handlePcpIdShow medicalLicenseValue: ",
        medicalLicenseValue,
      );
  ...
  const saveFormData = (values) => {
    ...
    if (true) {
      ...
      if (
        ...
        (apiJson["Cont_ProvFaciAnci_Details"].contractType === undefined ||
          apiJson["Cont_ProvFaciAnci_Details"].contractType === "")
      ) {
        setButtonDisableFlag(false);
  ...
  const updateFormData = (values) => {
    ...
    requestBody.contractNo =
      apiTestStateComp.contractNo !== undefined
        ? apiTestStateComp.contractNo
        : "";
    requestBody.medicareNo =
      apiTestStateComp.medicareNo !== undefined
        ? apiTestStateComp.medicareNo
        : "";
    requestBody.pcpId =
      apiTestStateComp.pcpId !== undefined ? apiTestStateComp.pcpId : "";
    requestBody.taxId =
      apiTestStateComp.taxId !== undefined ? apiTestStateComp.taxId : "";
    requestBody.medicalGrpNo =
      apiTestStateComp.medicalGrpNo !== undefined
        ? apiTestStateComp.medicalGrpNo
        : "";
    requestBody.capitationAmount =
      apiTestStateComp.capitationAmount !== undefined
        ? apiTestStateComp.capitationAmount
        : "";
    requestBody.awpFee =
      apiTestStateComp.awpFee !== undefined ? apiTestStateComp.awpFee : "";
    requestBody.medicalHomeFee =
      apiTestStateComp.medicalHomeFee !== undefined
        ? apiTestStateComp.medicalHomeFee
        : "";
    requestBody.careMgmtFee =
      apiTestStateComp.careMgmtFee !== undefined
        ? apiTestStateComp.careMgmtFee
        : "";
    requestBody.qualityBonus =
      apiTestStateComp.qualityBonus !== undefined
        ? apiTestStateComp.qualityBonus
        : "";
    requestBody.qualityFee =
      apiTestStateComp.qualityFee !== undefined
        ? apiTestStateComp.qualityFee
        : "";
    requestBody.contractTypeComp =
      apiTestStateComp.contractTypeComp !== undefined
        ? apiTestStateComp.contractTypeComp.value
        : "";
    requestBody.state1 =
      apiTestStateComp.state1 !== undefined
        ? apiTestStateComp.state1.value
        : "";
    requestBody.contract =
      apiTestStateComp.contract !== undefined
        ? apiTestStateComp.contract.value
        : "";
    requestBody.medicalLicense =
      apiTestStateComp.medicalLicense !== undefined
        ...
        : "";
    requestBody.state2 =
      apiTestStateComp.state2 !== undefined
        ? apiTestStateComp.state2.value
        : "";
    requestBody.riskAttribute =
      apiTestStateComp.riskAttribute !== undefined
        ? apiTestStateComp.riskAttribute.value
        : "";
    requestBody.capitationType =
      apiTestStateComp.capitationType !== undefined
        ? apiTestStateComp.capitationType.value
        : "";
    requestBody.capitationTerm =
      apiTestStateComp.capitationTerm !== undefined
        ? apiTestStateComp.capitationTerm.value
        : "";
    requestBody.criticalAccess =
      apiTestStateComp.criticalAccess !== undefined
    ...
    if (
      callProcRef.current === "callProc" &&
      (apiTestState.contractType === undefined ||
        apiTestState.contractType === "")
    ) {
      setButtonDisableFlag(false);
      alert("Please select Contract Type");
    ...
    if (
      ...
      apiTestStateComp.conEffectiveDate !== undefined
    ) {
      if (apiTestStateComp.conEffectiveDate.getTime() < todaydate.getTime()) {
        setButtonDisableFlag(false);
        alert(
          "Contract Effective Date should be greater or equals to today's date",
        );
        return;
      }
    }
        ...
        .then((res) => {
          ...
          if (apiStat === 0) {
            ...
            if (callProcRef.current === "callProc") {
              ...
              //navigateHome();
              console.log(
                "Inside updateFormData prop sending in submitCase",
                prop,
              );
          ...
          >
            ...
            <Tab eventKey="Compensation" title="Compensation">
              <CompensationTab
                ...
                lockStatus={
                  prop.state !== null && prop.state.lockStatus !== undefined
                              ...
                              <div className="col-xs-6 col-md-4">
                                <div className="form-floating">
                                  <Select
                                    classNames={{
                                      control: (state) =>
                                        `select-control-selector-1 ${selectData && selectData.selectThree && !selectData.selectThree.value ? "is-invalid" : ""}`,
                                    }}
                                    styles={{
                                      control: (provided) => ({
                                        ...provided,
                                    ...
                                    value={
                                      ...
                                      selectData.selectThree.value
                                        ? selectData &&
                                          ...
                                          selectData.selectThree.value
                                        : {
                                            label: apiTestState.contractType,
                                  ...
                                  {({
                                    ...
                                    <div className="form-floating">
                                      <input
                                        maxLength="30"
                                        type="text"
                                        className={`form-control ${meta.touched && meta.error ? " is-invalid" : field.value ? "is-valid" : ""}`}
                                        placeholder="John"
                                        {...field}
                                      />
                              ...
                              <div className="col-xs-6 col-md-4">
                                <div className="form-floating">
                                  ...
                                  <Select
                                    ...
                                    value={
                                      selectData &&
                                      selectData.selectOne &&
                                      selectData.selectOne.value
                                        ? selectData &&
                                          selectData.selectOne &&
                                          selectData.selectOne.value
                                        : {
                                            label: apiTestState.provState,
                                            value: apiTestState.provState,
                                          }
                                    }
                                    onFocus={() => {}}
                                    ref={stateRef}
                              ...
                              <div className="col-xs-6 col-md-4">
                                <div className="">
                                  ...
                                  <Select
                                    classNames={{
                                      control: (state) =>
                                        `select-control-selector-1 ${selectData && selectData.selectTwo && !selectData.selectTwo.value ? "is-invalid" : ""}`,
                                    }}
                                    id="stateDropdown"
                                    placeholder="State"
                                    isDisabled={
                                    ...
                                    options={
                                      !!selectValues.stateArray &&
                                      selectValues.stateArray.length > 0
                                        ? selectValues.stateArray
                                        : [{ label: "option", value: "option" }]
                                    }
                                    // styles={{...customStyles}}
