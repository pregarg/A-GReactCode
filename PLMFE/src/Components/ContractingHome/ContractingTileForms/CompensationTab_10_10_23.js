...
export default function CompensationTab({apiTestStateComp,firlTableRowsData,compensationTableRowsData,deleteTableRows, handleGridSelectChange, addTableRows,
    handleGridFieldChange,gridRowsFinalSubmit, handleLinearSelectChange, handleLinearFieldChange,handleMedicalGrpNoShow,lockStatus,handleDateChange,handleNetworkIdShow,handlePcpIdShow,transactionType}) {
...
const { ValueContainer, Placeholder } = components;
   ...
   if(mastersSelector.hasOwnProperty('masterCompositionMaster')){
        ...
        riskAssignmentSelect = (compMaster.hasOwnProperty('riskAssignment')?compMaster['riskAssignment']:[]);
        stateSelect = (compMaster.hasOwnProperty('states')?compMaster['states']:[]);
        feeScheduleSelect = (compMaster.hasOwnProperty('feeSchedule')?compMaster['feeSchedule']:[]);
        criticalAccessHospitalSelect = (compMaster.hasOwnProperty('criticalAccessHospital')?compMaster['criticalAccessHospital']:[]);
        seqAppliesSelect = (compMaster.hasOwnProperty('seqApplies')?compMaster['seqApplies']:[]);
        contractTypeSelect = (compMaster.hasOwnProperty('contractType')?compMaster['contractType']:[]);
        scheduleSelect = (compMaster.hasOwnProperty('schedule')?compMaster['schedule']:[]);



   }
   else {const compMaster =""}
            ...
            <div className="container" style={{ overflow: "auto", height: "auto", minHeight: "100%", paddingBottom: 60 }}>
                <div className="row">
                    <div className="col-xs-12">
                        <div className="accordion CompensationTabLabel" id="accordionPanelsStayOpenExample">
                                ...
                                <div id="panelsStayOpen-collapseTwo" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                                    <div className="accordion-body AddProviderLabel">
                                        ...
                                        <div className="col-xs-6 col-md-3">
                                            ...
                                            <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="12" type="text" className='form-control' name="taxId" placeholder="John"
                                                    value={apiTestStateComp.taxId}
                                                    onChange={(event) => handleLinearFieldChange(event)}
                                        ...
                                        <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="10" type="text" className='form-control' name="groupRiskId" placeholder="John"
                                                    value={apiTestStateComp.groupRiskId}
                                                    onChange={(event) => handleLinearFieldChange(event)} disabled required/>
                                                    <label htmlFor="floatingInputGrid">Group Risk ID</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="panelsStayOpen-collapseTwo" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                                    <div className="accordion-body AddProviderLabel">
                                        ...
                                        <div className="row my-2">
                                            ...
                                            <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="10" type="text" className='form-control' name="medicalLicense" placeholder="John"
                                                    value={apiTestStateComp.medicalLicense}
                                                    onChange={(event) => handleLinearFieldChange(event)}
                                                    onBlur={(event) => handlePcpIdShow(event)}
                                                         />
                                                    <label htmlFor="floatingInputGrid">Medical License</label>
                                                </div>
                                            </div>
                                            <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="12" type="text" className='form-control' name="pcpId" placeholder="John"
                                ...
                                <div id="panelsStayOpen-collapseTwo" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                                    <div className="accordion-body AddProviderLabel">
                                      ...
                                      <div className="col-xs-6 col-md-3 ">
                                            ...
                                            <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="20" type="text" className='form-control' name="planValue" placeholder="John"
                                                    value={apiTestStateComp.planValue}
                                                    onChange={(event) => handleLinearFieldChange(event)}
                                                    onBlur={(event) => handleNetworkIdShow(event)}

                                                    />
                                                    <label htmlFor="floatingInputGrid">Plan Value</label>
                                                </div>
                                            </div>
                                               ...
                                               <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="12" type="text" className='form-control' name="networkId" placeholder="John"
                                                    value={apiTestStateComp.networkId}
                                                    onChange={(event) => handleLinearFieldChange(event)}  disabled required/>
                                                    <label htmlFor="floatingInputGrid">Network ID</label>
                                                </div>
                                               </div>
                                    </div>
                    ...
                    <>
                            <div className="accordion-item">
                                ...
                                <div id="panelsStayOpen-collapseTwo" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                                                ...
                                                <div className="col-xs-6 col-md-3">
                                                  <div>
                                                    <ReactDatePicker
                                                      ...
                                                      onChange={event => handleDateChange(event,"conEffectiveDate" )}
                                    ...
                                    <div className="col-xs-6 col-md-12">
                                            <table className="table table-bordered tableLayout" id="QuestionTable">
                                                <thead>
                                                    <tr className='tableRowStyle tableHeaderColor'>
                                                        <th style={{width:"10%"}} scope="col">S. No.</th>
                                                        <th style={{width:"70%"}}scope="col">CheckList</th>
                                                        <th style={{textAlign:"center"}} scope="col">Please select</th>
                                                        </tr>
                                                        </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td>FFS No Quality(I)  :  Category 1 (B-Payments)</td>
                                                        <td>
                                                <Select
                                                    name = "qualityFlagI"
                                                    isDisabled={false}
                                                ...
                                                />
                                                    ...
                                                    <tr>
                                                        <td>2</td>
                                                        <td>FFS with Quality(J)  :  Category 2 (C-Payments)</td>
                                                        <td>
                                                <Select
                                                    name = "qualityFlagJ"
                                                    isDisabled={false}
                                                ...
                                                />
                                                    ...
                                                    <tr>
                                                        <td>3</td>
                                                        <td>APM-FFS-Shared Risk(K)  :  Category 3 (D-Payments)</td>
                                                        <td>
                                                <Select
                                                    name = "qualityFlagK"
                                                    isDisabled={false}
                                                ...
                                                />
                                                    ...
                                                    <tr>
                                                        <td>4</td>
                                                        <td>FFS Based on Population(M)  :  Category 5 (F-Payments)</td>
                                                        <td>
                                                <Select
                                                    name = "qualityFlagM"
                                                    isDisabled={false}
                                                ...
                                                />
                                                    ...
                                                    <tr>
                                                        <td>5</td>
                                                        <td>Risk Based Payments NOT Linked to Quality(L)  :  APM 3N (E-Payments)</td>
                                                        <td>
                                                <Select
                                                    name = "qualityFlagL"
                                                    isDisabled={false}
                                                ...
                                                />
                                                    ...
                                                    <tr>
                                                        <td>5</td>
                                                        <td>Capitated Payments NOT Linked to Quality(N)  :  APM 3N (G-Payments)</td>
                                                        <td>
                                                <Select
                                                    name = "qualityFlagN"
                                                    isDisabled={false}
                                    ...
                                    <div className="row my-2">
                                        <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="12" type="text" className='form-control' name="starsIncentive" placeholder="John"
                                                    value={apiTestStateComp.starsIncentive}
                                                    onChange={(event) => handleLinearFieldChange(event)}/>
                                                    <label htmlFor="floatingInputGrid">Stars Incentive</label>
                                                </div>
                                            </div>

                                            <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="12" type="text" className='form-control' name="awvIncentive" placeholder="John"
                                                    value={apiTestStateComp.awvIncentive}
                                                    onChange={(event) => handleLinearFieldChange(event)} />
                                                    <label htmlFor="floatingInputGrid">AWV Incentive</label>
                                                </div>
                                            </div>

                                            <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="20" type="text" className='form-control' name="medicalHome" placeholder="John"
                                                    value={apiTestStateComp.medicalHome}
                                                    onChange={(event) => handleLinearFieldChange(event)} />
                                                    <label htmlFor="floatingInputGrid">Medical Home</label>
                                                </div>
                                            </div>
                            ...
                            <div className="accordion-item">
                                ...
                                <button className="accordion-button accordionButtonStyle" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFIRL" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                                     Hospital Compensation
                                </button>
                                </h2>
                                <div id="panelsStayOpen-collapseFIRL" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-FIRL">
                                    ...
                                    <div className="row my-2">
                                        ...
                                        <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="12" type="text" className='form-control' name="pricingAWP" placeholder="John"
                                                    value={apiTestStateComp.pricingAWP}
                                                    onChange={(event) => handleLinearFieldChange(event)} />
                                                    <label htmlFor="floatingInputGrid">AWP Pricing -Drugs</label>
                                                </div>
                                        </div>

                                         <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="12" type="text" className='form-control' name="pricingASP" placeholder="John"
                                                    value={apiTestStateComp.pricingASP}
                                                    onChange={(event) => handleLinearFieldChange(event)} />
                                                    <label htmlFor="floatingInputGrid">ASP Pricing Drugs</label>
                                        </div>
                                        </div>
                                    </div>
                            ...
                            <div className="accordion-item">
                                <h2 className="accordion-header" id="panelsStayOpen-Compensation">
                                <button className="accordion-button accordionButtonStyle" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseCompensation" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                                Provider Compensation
                                </button>
                                </h2>
                                <div id="panelsStayOpen-collapseCompensation" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-Compensation">
                                    <div className="accordion-body">
                                        <div className="row">
                                            <div className="col-xs-6 col-md-12">
                                                <CompensationTable
                                        ...
                                        {/*<div className="col-xs-6 col-md-3">
                                            ...
                                            <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="20" type="text" className='form-control' name="annualEscl" placeholder="John"
                                                    value={apiTestStateComp.annualEscl}
                                                    onChange={(event) => handleLinearFieldChange(event)}/>
                                                    <label htmlFor="floatingInputGrid">Annual Escalator</label>
                                                </div>
                                            ...
                                            <div className="col-xs-6 col-md-3">
                                                <div className="form-floating">
                                                    <input maxLength="50" type="text" className='form-control' name="terminationClause" placeholder="John"
                                                    value={apiTestStateComp.terminationClause}
                                                    onChange={(event) => handleLinearFieldChange(event)} />
                                                    <label htmlFor="floatingInputGrid">Termination Clause</label>
                                                </div>
                                            </div>
                                                ...
                                                <div className="col-xs-6 col-md-3">
                                                  <div>
                                                    <ReactDatePicker
                                                      ...
                                                      onChange={event => handleDateChange(event,"mocAttestationDate" )}
                                                      dateFormat="MM/dd/yyyy"
                                                    //   readOnly={(tabRef.current==='DashboardView'&&(prop.state.lockStatus!==undefined && prop.state.lockStatus==='Y')?true:false)}
                                                      peekNextMonth
                                                      onKeyDown={(e) => {
                                                ...
                                                <div className="col-xs-6 col-md-3">
                                                  <div>
                                                    <ReactDatePicker
                                                      ...
                                                      onChange={event => handleDateChange(event,"mocRenewalAttDate" )}
                                                      dateFormat="MM/dd/yyyy"
                                                    //   readOnly={(tabRef.current==='DashboardView'&&(prop.state.lockStatus!==undefined && prop.state.lockStatus==='Y')?true:false)}
                                                      peekNextMonth
                                                      onKeyDown={(e) => {
