    ...
    return (
      ...
      <div id='headerLogo'>
        ...
        <div className="row mb-2">
          ...
          <div className="col-xs-6 col-md-4" style={{backgroundSize: "120px",background:`url(${dashboardHeaderLogo}) no-repeat !important`}}></div>
          <div className="col-xs-6 col-md-4" style={{marginTop:"10px"}}>
            <div className="col-xs-6 col-md-2 mx-2" style={{float:"right"}}>
      ...
      <div className="SelfServiceComponent contractingBackground"  style={{ backgroundImage:`url(${ContractingBackGroundImage})` , height:"100vh" , overflow:"auto"}}>
          ...
          <div className="Container centered">
            ...
            <div className="row ">
              <div className="col-md-7 col-md-3">
                ...
                <Link className="stretched-link text-decoration-none cardBorder" to="/ContractingHome/ProviderContracting" state={{
                  formNames: "Provider", userName:userName}}>
                <div className="cardBackground" style={{backgroundImage:`url(${Provider})`}}></div>
              ...
              <div className="col-md-5 col-md-3">
                <div className="card tilestyle" style={{width: "15rem"}}>
                <Link className="stretched-link text-decoration-none cardBorder" to="/ContractingHome/FacAncHealthSystem" state={{
                  formNames: "FacAncHealthSystem", userName:userName}}>
                <div className="cardBackground" style={{backgroundImage:`url(${FacAncHealthSystem})`}}></div>
                <div className="card-block">
                  <h5 className="card-title tile-header">Facility/Ancillary/Health System</h5>
                </div>
                </Link>
                </div>
              </div>
