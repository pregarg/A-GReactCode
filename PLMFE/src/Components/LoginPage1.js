  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          overflow: "hidden",
          height: document.documentElement.clientHeight * 0.94 + "px",
        }}
      >
          ...
          <div style={{ display: "flex", textAlign: "left", marginTop: 60 }}>
            ...
            <div>
              <label className="homeDescriptionText">
                <p className="homeTaglineText" style={{ marginBottom: 0 }}>
                  Welcome to Provider Online Portal, A New Way To Serve
                  Providers.
                </p>
                <p style={{ width: "95%" }}>
                  In this portal you can view current statuses, submit new
                  requests, view and download documents and maintain existing
                  data related to the Providers. All Provider change can be done
                  on the Self Service Page. If your organization wants to
                  network with us and has not done so already, please click on
                  “Register” button to fill a Network Request Form with us. If
                  you are currently in network with us, please login.
                </p>
              </label>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-xs-6 col-md-6 loginSection">
              <img
                ...
                alt="..."
                style={{
                  boxShadow: "rgb(126 142 177 / 35%) 0px 0px 3px 3px",
                  borderRadius: 5,
                }}
              ></img>
            </div>
            <div
              className="col-xs-6 col-md-6 loginSection"
              style={{
                boxShadow: "rgb(126 142 177 / 35%) 0px 0px 3px 3px",
                borderRadius: 5,
                backgroundColor: "#FFF",
            ...
            >
              <label id="loginDefinition" className="PortalLoginLabel">
                Portal Login
              </label>
              ...
              <div className="loginFieldContainer">
                ...
                <input
                  ...
                  type="password"
                  onChange={(event) => handleChange(event)}
                  value={changeState.passwordField}
                />
              </div>
              <div className="loginButtonContainer">
                <button
                  className="loginPageBottomButton button"
                  id="loginButton"
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <label id="loginPageBottomLabel">
                  Do you have trouble logging in? Please contact our customer
                  support at{" "}
                  <span
                    style={{
                      color: "var(--primary)",
