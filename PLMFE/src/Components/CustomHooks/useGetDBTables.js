  ...
  const getTableDetails = () => {
    let tableJson = {
      ...
      pdTables: [
        ...
        "PD_Redirect_To~pdProviderRedirectTo",
        "PD_Review~pdReview",
        "PD_Case_Resolution~pdCaseResolution",
      ...
      ctmTables:[
        ...
        "CTM_Case_Timelines~ctmCaseTimelines",
         ...
         "CTM_Representative_Information~ctmRepresentativeInformation",
          ...
          "CTM_Case_Information1~ctmInformation",
          "CTM_Case_Resolution_Decision~ctmResolutionDecision",
