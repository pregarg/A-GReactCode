          ...
          <table className="table table-striped table-bordered dashboardTableBorder" style={{textAlign:"center"}}>
                ...
                <tbody >
                  <tr>
                    ...
                    <td>
                      <img id ='welcomeContentImage' src ={documentTableImage} className="img-fluid" alt="..."
                      style={{height:"30px",background:"inherit"}}></img>
                    </td>
                  </tr>
                  <tr>
                    <td>Contract</td>
                    <td>
                      <img id = 'contractImage' src = {documentTableImage} className="img-fluid" alt="..." 
                      style={{height:"30px",background:"inherit"}}></img>
                    </td>
                  </tr>
                </tbody>
