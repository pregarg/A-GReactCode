...
const RepresentativeAddRecordsAccordion = (props) => {
  ...
  const [representativeAddData, setRepresentativeAddData] = useState(props.representativeAddData || {});

  const handleRepresentativeAddData = (name, value, persist) => {
    const newData = {
      ...representativeAddData,
      [name]: typeof value === "string" ? convertToCase(value) : value,
    };
    setRepresentativeAddData(newData);
    if (persist) {
      props.setRepresentativeAddData(newData);
    }
  };
  const persistRepresentativeAddDataData = () => {
    props.setRepresentativeAddData(representativeAddData);
  };
  ...
  const renderInputField = (name, placeholder, maxLength) => (
      <div className="col-xs-6 col-md-4">
        <FormikInputField
            ...
            persist={persistRepresentativeAddDataData}
  ...
  return (
      <Formik
          initialValues={props.representativeAddData}
          validationSchema={props.representativeAddOfRecordsValidationSchema}
          onSubmit={() => {}}
          enableReinitialize
      >
        {() => (
            <Form>
              <div className="accordion-item" id="caseTimelines">
                <h2 className="accordion-header" id="panelsStayOpen-Timelines">
                  ...
                  >
                    Representative Address Of Records
                  </button>
                </h2>
                <div
...
export default RepresentativeAddRecordsAccordion;
