...
export default function ProviderInformationSearch(modalProps) {
  ...
  return (
      <>
        <Modal
            show={modalProps.showProviderInformationSearch}
            onHide={() => {
        ...
        >
                    ...
                    <div className="col-xs-12 col-md-3">
                      <div className="form-floating mb-3">
                        <input
                            ...
                            value={
                                modalProps.selectSearchValues?.providerFirstName || ""
                            }
                            onChange={(event) => handleCriteriaChangeValue(event)}
                            disabled={
                                modalProps.selectedCriteria !== "providerFirstName"
                            }
                        />
                        <label htmlFor="providerFirstNameVal">
                          Provider First Name
                        </label>
                      </div>
                    </div>
                    <div className="col-xs-12 col-md-3">
                      <div className="form-floating mb-3">
                        <input
                            ...
                            value={
                                modalProps.selectSearchValues?.providerLastName || ""
                            }
                            onChange={(event) => handleCriteriaChangeValue(event)}
                            disabled={
                                modalProps.selectedCriteria !== "providerFirstName"
                        ...
                        />
                        <label htmlFor="providerLastNameVal">
                          Provider Last Name
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="col-xs-12 col-md-3">
                      <div className="form-floating mb-3">
                        <input
                            ...
                            value={
                                modalProps.selectSearchValues?.providerFirstName2 ||
                                ""
                            }
                            onChange={(event) => handleCriteriaChangeValue(event)}
                            disabled={
                                modalProps.selectedCriteria !== "providerFirstName2"
                            }
                        />
                        <label htmlFor="providerFirstNameVal2">
                          Provider First Name
                        </label>
                      </div>
                    </div>
                    <div className="col-xs-12 col-md-3">
                      <div className="form-floating mb-3">
                        <input
                            ...
                            value={
                                modalProps.selectSearchValues?.providerLastName2 || ""
                            }
                            onChange={(event) => handleCriteriaChangeValue(event)}
                            disabled={
                                modalProps.selectedCriteria !== "providerFirstName2"
                        ...
                        />
                        <label htmlFor="providerLastNameVal2">
                          Provider Last Name
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="col-xs-12 col-md-3">
                      <div className="form-floating mb-3">
                        <input
                            ...
                            name="facilityName"
                            value={
                                modalProps.selectSearchValues?.facilityName || ""
                            }
                            onChange={(event) => handleCriteriaChangeValue(event)}
                            disabled={
                                modalProps.selectedCriteria !== "facilityName"
                            }
                        />
                    ...
                    <div className="col-xs-12 col-md-3">
                      <div className="form-floating mb-3">
                        <input
                            ...
                            name="facilitycity"
                            value={
                                modalProps.selectSearchValues?.facilitycity || ""
                            }
                            onChange={(event) => handleCriteriaChangeValue(event)}
                            disabled={
                                modalProps.selectedCriteria !== "facilityName"
                    ...
                    <div className="col-xs-12 col-md-3">
                      <div className="form-floating mb-3">
                        <input
                            ...
                            name="facilityState"
                            value={
                                modalProps.selectSearchValues?.facilityState || ""
                            }
                            onChange={(event) => handleCriteriaChangeValue(event)}
                            disabled={
                                modalProps.selectedCriteria !== "facilityName"
                    ...
                    <div className="col-xs-12 col-md-3">
                      <div className="form-floating mb-3">
                        <input
                            ...
                            name="facilityName2"
                            value={
                                modalProps.selectSearchValues?.facilityName2 || ""
                            }
                            onChange={(event) => handleCriteriaChangeValue(event)}
                            disabled={
                                modalProps.selectedCriteria !== "facilityName2"
                            }
                        />
                    ...
                    <div className="col-xs-12 col-md-3">
                      <div className="form-floating mb-3">
                        <input
                            ...
                            name="facilityState2"
                            value={
                                modalProps.selectSearchValues?.facilityState2 || ""
                            }
                            onChange={(event) => handleCriteriaChangeValue(event)}
                            disabled={
                                modalProps.selectedCriteria !== "facilityName2"
          ...
          <div style={{ overflowX: "auto", maxWidth: "100%" }}>
            {modalProps.responseData.length > 0 &&
                modalProps.ProviderInformationSearchTableComponent()}
          </div>
          <br></br>
          {modalProps.responseData.length > 0 && (
              <Button
                  ...
                  onClick={() => {
                    modalProps.handleSelectedProviderInformations(false);
                  }}
              >
                Populate Data
              </Button>
