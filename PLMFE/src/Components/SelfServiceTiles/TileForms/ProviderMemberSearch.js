...
export default function ProviderMemberSearch(modalProps) {
  ...
  return (
    <>
      <Modal
        show={modalProps.showProviderMemberSearch}
        onHide={() => {
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            onClick={() => {
              modalProps.handleClearProviderMemberSearch(false);
            }}
          >
            Clear
          </Button>
        ...
        <div style={{ overflowX: "auto", maxWidth: "100%" }}>
          {modalProps.responseData.length > 0 &&
            modalProps.ProvidermemberSearchTableComponent()}
        </div>
        <br></br>
        {modalProps.responseData.length > 0 && (
          <Button
