...
export default function GroupPayTo() {
  ...
  return (
    <>
    <div className="GroupPayTo backgroundColor" style={{minHeight:"100vh"}}>
                                    ...
                                    <div className="accordion-body">
                                        <div className="row">
                                            <div className="col-xs-6 col-md-12">
                                                <PayToTable payToTableRowsData={payToTableRowsData} addTableRows={addTableRows}
                                                deleteTableRows={deleteTableRows} calledFormName={GroupPayTo.validate} 
                                                handleGridSelectChange={handleGridSelectChange} handleGridFieldChange={handleGridFieldChange} modifyValidatedAddressPayToRow={modifyValidatedAddressPayToRow}></PayToTable>
                                            </div>
                                        </div>
                                    </div>
                                </div>
