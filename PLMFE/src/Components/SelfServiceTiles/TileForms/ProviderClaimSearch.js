...
export default function ProviderClaimSearch(modalProps) {
  ...
  return (
    <>
      <Modal
        show={modalProps.showProviderClaimSearch}
        onHide={() => {
      ...
      >
                  ...
                  <div className="col-xs-12 col-md-3">
                    <div className="form-floating mb-2">
                      <input
                        ...
                        name="claimNumber"
                        value={modalProps.selectSearchValues?.ProviderclaimNumber || ""}
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            onClick={() => {
              modalProps.handleClearProviderClaimSearch(false);
            }}
          >
            Clear
          </Button>
        ...
        <div style={{ overflowX: "auto", maxWidth: "100%" }}>
          {modalProps.responseData.length > 0 &&
            modalProps.ProviderclaimSearchTableComponent()}
        </div>
        <br></br>
        {modalProps.responseData.length > 0 && (
          <Button
