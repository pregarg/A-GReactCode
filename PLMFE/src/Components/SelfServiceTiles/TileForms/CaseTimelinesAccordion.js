                ...
                >
                  <div className="accordion-body">
                    <div className="row my-2">
                      {renderSelectField('Case_Filing_Method', 'Case Filing Method', caseFilingMethodValues)}
                      {renderInputField("Case_Aging", "Case Aging", 16)}
                      {renderInputField("Compliance_Time_Left_to_Finish", "Compliance Time Left to Finish", 16)}
                    </div>
                    <div className="row my-2">
                      {renderInputField("Acknowledgment_Timely", "Acknowledgement Timely", 16)}
                      {renderInputField("Timeframe_Extended", "Timeframe Extended", 30)}
                      {renderInputField("Case_in_Compliance", "Case in Compliance", 30)}
                    </div>
                    <div className="row my-2">
                      {renderInputField("Out_of_Compliance_Reason", "Out of Compliance Reason", 30)}
                      {renderDatePicker("Case_Received_Date", "Case Received Date", "Case Received Date")}
                      {renderDatePicker("AOR_Received_Date", "AOR Received Date", "AOR Received Date")}
                    </div>
                    <div className="row">
                      {renderDatePicker("WOL_Received_Date", "WOL Received Date", "WOL Received Date")}
                    </div>
                  </div>
                </div>
              </div>
