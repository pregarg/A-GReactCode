...
export default function LocationTable({
  ...
  const validateAddress = (index, flag) => {
    ...
    if (
      !("address1" in oldAddress) ||
      oldAddress["address1"].value === "" ||
      !("city" in oldAddress) ||
      oldAddress["city"].value === "" ||
      !("stateValue" in oldAddress) ||
      oldAddress["stateValue"].value === "" ||
      !("zipCode" in oldAddress) ||
      oldAddress["zipCode"].value === ""
    ) {
        ...
        <table className="table table-striped table-bordered dashboardTableBorder ">
          ...
          <tbody>
            <tr>
              ...
              <td className="tableData">{newAdd.state}</td>
                ...
                <input
                  ...
                  value={
                    ...
                    data.officeFaxNumber.value !== undefined
                      ? data.officeFaxNumber.value
                      : data.officeFaxNumber
                  }
                  onChange={(evnt) =>
                    handleGridFieldChange(
                      index,
