              ...
              <div className="col-xs-6 col-md-6">
                <div className="form-floating">
                  <input
                    ...
                    name="workstepName"
                    value={
                      "workstepName" in data &&
                      data.workstepName.value !== undefined
              ...
              <div className="col-xs-6 col-md-6">
                <div className="form-floating">
                  <input
                    ...
                    name="caseDec"
                    value={
                      "caseDecision" in data &&
                      data.caseDecision.value !== undefined
              ...
              <div className="col-xs-6 col-md-6">
                <div className="form-floating">
                  <input
                    ...
                    name="entryDateTime"
                    value={
                      "entryDateTime" in data &&
                      data.entryDateTime.value !== undefined
                        ? prop.formatDecHistDate(data.entryDateTime.value)
                        : prop.formatDecHistDate(data.entryDateTime)
                    }
                  />
              ...
              <div className="col-xs-6 col-md-6">
                <div className="form-floating">
                  <input
                    ...
                    name="exitDateTime"
                    value={
                      "exitDateTime" in data &&
                      data.exitDateTime.value !== undefined
                        ? prop.formatDecHistDate(data.exitDateTime.value)
                        : prop.formatDecHistDate(data.exitDateTime)
                    }
                  />
              ...
              <div className="col-xs-6 col-md-12">
                <div className="form-floating">
                  <textarea
                    ...
                    name="caseNotes"
                    value={
                      "caseDecNotes" in data &&
                      data.caseDecNotes.value !== undefined
                        ? data.caseDecNotes.value
                        : data.caseDecNotes
                    }
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>{gridData()}</Modal.Body>
