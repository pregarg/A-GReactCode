...
export default function NewUser() {
    ...
    for (let i = 0; i < keys.length; i++) {
      if (formData[keys[i]].required) {
        if (
          ...
          formData[keys[i]].value.trim().length == 0
        ) {
          ...
          formData[keys[i]].validEmail &&
          !formData[keys[i]].value.match(
  ...
  useEffect(() => {
    if (isFormValid) {
      ...
      axios
        .post(baseURL + "/saveUserManagement", newUserData, {
                  ...
                  <div className="col-xs-6 col-md-6">
                    <div className="form-floating">
                      <input
                        ...
                        maxLength="100"
                        onChange={(e) =>
                          updateFormData(e.target.value, "firstname")
                        }
                      />
                  ...
                  <div className="col-xs-6 col-md-6">
                    <div className="form-floating">
                      <input
                        ...
                        maxLength="100"
                        onChange={(e) =>
                          updateFormData(e.target.value, "lastname")
                        }
                      />
                  ...
                  <div className="col-xs-6 col-md-6">
                    <div className="form-floating">
                      <input
                        ...
                        name="username"
                        onChange={(e) =>
                          updateFormData(e.target.value, "username")
                        }
                        maxLength="10"
                      ></input>
                  ...
                  <div className="col-xs-6 col-md-6">
                    <div className="form-floating">
                      <input
                        type="text"
                        className={
                          formData.mailid.isInvalid
                            ? "form-control is-invalid"
                            : "form-control"
                        }
                        id="mailid"
                        placeholder="mailid"
                        value={formData.mailid.value}
                        name="mailid"
                        onChange={(e) =>
                          updateFormData(e.target.value, "mailid")
                        }
                        maxLength="50"
                      ></input>
                  ...
                  <div className="col-xs-6 col-md-6">
                    <div className="form-floating">
                      <select
                        ...
                        onChange={(e) =>
                          updateFormData(e.target.value, "usertype")
                        }
                        name="usertype"
                      >
                  ...
                  <div className="col-xs-6 col-md-6">
                    <div className="form-floating">
                      <input
                        ...
                        name="comment"
                        onChange={(e) =>
                          updateFormData(e.target.value, "comment")
                        }
                        maxLength="250"
                      ></input>
